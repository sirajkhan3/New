...
module.exports.handleEvent = async function ({ api, event }) {
  ...
  const responses = {
    ...
    "good night": "Sweet Dream babu… তবে আগে সিরাজ বস কে GN বলে নিও 😏💤",
    "tor ball": "~ এখনো বাল উঠে নাই নাকি তোমার?? 🤖",
    "siraj": "উনি এখন কাজে বিজি আছে কি বলবেন আমাকে বলতে পারেন..!😘",
    "owner": "‎[𝐎𝐖𝐍𝐄𝐑:☞ SIRAJ KHAN ☜\nFacebook: https://www.facebook.com/profile.php?id=100044713412032\nWhatsApp: +8801882333052",
    "admin": "He is SIRAJ KHAN তাকে সবাই Admin SIRAJ BHAI হিসেবে চিনে😘☺️",
    ...
    "tui ke": "আমি তোর বস RAHUL এর ChatBot 😏",
    "umm": "এতো Umm কেনো জানু… কিছু বলবা? 😉",
    "hmm": "Hmmm কিসের হুমম জানু 🥵",
    "love": "Love করলে সরাসরি সিরাজ বস কে বল জানু 😻🔥"
  };
